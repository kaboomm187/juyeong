...
<title>Atropos - Responsive Multipurpose</title>
		...
		<!--<link id="css_dark_skin" href="design/css/layout-dark.css" rel="stylesheet" type="text/css" />--><!-- DARK SKIN -->
	...
	<body><!-- Available classes for body: boxed , pattern1...pattern10 . Background Image - example add: data-background="design/images/boxed_background/1.jpg"  -->
			...
			<div class="container">
				...
				<div class="btn-group pull-right hidden-xs">
					<button class="dropdown-toggle language" type="button" data-toggle="dropdown">
						<img src="design/images/flags/us.png" width="16" height="11" alt="EN Language" /> English <span class="caret"></span>
					</button>

					<ul class="dropdown-menu">
						<li>
							<a href="#">
								<img src="design/images/flags/us.png" width="16" height="11" alt="EN Language" /> [US] English
							</a>
						</li>
						<li>
							<a href="#">
								<img src="design/images/flags/de.png" width="16" height="11" alt="DE Language" /> [DE] German
							</a>
						</li>
						<li>
							<a href="#">
								<img src="design/images/flags/fr.png" width="16" height="11" alt="FR Language" /> [FR] French
							</a>
						</li>
						<li>
							<a href="#">
								<img src="design/images/flags/ru.png" width="16" height="11" alt="RU Language" /> [RU] Russian
							</a>
						</li>
					</ul>
				</div>
							...
							<li class="quick-cart">
								...
								<div class="quick-cart-content">
									...
									<a class="item" href="shop-product-full-width.html"><!-- item 1 -->
										<img class="pull-left" src="design/images/demo/shop/thumb/1.jpg" width="40" alt="quick cart" />
									...
									<a class="item" href="shop-product-full-width.html"><!-- item 2 -->
										<img class="pull-left" src="design/images/demo/shop/thumb/2.jpg" width="40" alt="quick cart" />
										<div class="inline-block">
									...
									<a class="item" href="shop-product-full-width.html"><!-- item 3 -->
										<img class="pull-left" src="design/images/demo/shop/thumb/4.jpg" width="40" alt="quick cart" />
										<div class="inline-block">
							...
							<form class="white-row" method="post" action="memberRegister.do">
								...
								<div class="row">
									<div class="form-group">
										<div class="col-md-12">
											<label>이메일</label>
											<input type="text" name="memberId" value="${memDetInfoDto.memberId}" class="form-control">
										</div>
									</div>
								</div>
								<div class="row">
								...
								<div class="row">
									<div class="form-group">
										<div class="col-md-12">
											<label>생년월일</label>
											<input type="text" name="birthDate" value="${memDetInfoDto.birthDate}" class="form-control">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="form-group">
										<div class="col-md-12">
											<label>성별</label>
											<input type="text" name="gender" value="${memDetInfoDto.gender}" class="form-control">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="form-group">
										<div class="col-md-12">
											<label>전화번호</label>
											<input type="text" name="phoneNum" value="${memDetInfoDto.phoneNum}" class="form-control">
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="form-group">
										<div class="col-md-12">
											<label>자기소개</label>
											<input type="text" name="selfIntro" value="${memDetInfoDto.selfIntro}" class="form-control">
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="form-group">
										<div class="col-md-12">
											<label>사진경로</label>
											<input type="text" name="photoPath" value="${memDetInfoDto.phonePath}" class="form-control">
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="form-group">
										<div class="col-md-12">
											<label>관심음식</label>
											<input type="text" name="interestFood" value="${memDetInfoDto.interestFood}" class="form-control">
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="form-group">
										<div class="col-md-12">
											<label>닉네임</label>
											<input type="text" name="nickname" value="${memDetInfoDto.nickname}" class="form-control">
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-12">
										<input type="submit" value="계정만들기" class="btn btn-primary pull-right push-bottom" data-loading-text="Loading...">
									</div>
								</div>
		...
		<script type="text/javascript" src="design/plugins/holder.js"></script><!-- remove on production -->
